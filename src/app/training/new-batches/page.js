      ...
      <section className="relative overflow-hidden bg-black px-6 py-20">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col gap-6">
          ...
          <p className="max-w-xl text-sm md:text-base text-slate-200">
            We&apos;re finalising the next batch schedule for Beginner &amp; Professional Training
            programs. Timings and start dates will be published here shortly.
          </p>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-300 md:text-sm">
              ...
              <span>Share your preferred timings, we&apos;ll align you to the right batch.</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl">
          <div className="rounded-3xl border border-dashed border-gray-300 bg-white/80 p-8 text-center shadow-sm">
            ...
            <h2 className="mt-4 text-xl font-semibold text-gray-900 md:text-2xl">
              Batch details will be published soon
            </h2>

            <p className="mt-3 text-sm text-gray-600 md:text-base">
              We are currently aligning faculty schedules, student preferences, and time slots for
              the next set of batches across Python, Web Development, Data Engineering, Cloud,
              DevOps, and AI.
            </p>

            <div className="mt-6 grid gap-4 text-sm text-gray-700 md:grid-cols-3">
              <div className="rounded-2xl bg-gray-50 p-3">
                <p className="font-semibold text-gray-900 text-sm">Flexible Timings</p>
                <p className="mt-1 text-xs text-gray-600">
                  Weekend &amp; weekday options based on demand.
                </p>
              </div>
              <div className="rounded-2xl bg-gray-50 p-3">
                <p className="font-semibold text-gray-900 text-sm">Online &amp; Hybrid</p>
                <p className="mt-1 text-xs text-gray-600">
                  Instructor-led sessions with recordings and practice.
                </p>
              </div>
              <div className="rounded-2xl bg-gray-50 p-3">
                <p className="font-semibold text-gray-900 text-sm">Beginner to Advanced</p>
                <p className="mt-1 text-xs text-gray-600">
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-3 text-xs text-gray-600">
              <span>Want to block your seat in advance?</span>
              <Link
                href="/request-callback"
