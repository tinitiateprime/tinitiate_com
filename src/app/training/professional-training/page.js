...
// import Image from "next/image";
// import Link from "next/link";
// import { FiArrowRight, FiCheckCircle, FiPhone, FiCpu } from "react-icons/fi";
...
// // NOTE: For any tech where you want an image instead of an icon,
// // set Icon: "none" and provide img: "/path.png". This is GLOBAL.
// // =====================================================================================
// const STACK_TECH = {
//   // Frontend
...
//   // ✅ Image-based tech example (no icon, use image everywhere)
...
//   // ✅ If you want Azure DevOps as image, just set Icon:"none" + img once (global)
//   azuredevops: {
//     name: "Azure DevOps",
//     Icon: VscAzureDevops,
//     img: "/images/courses/azureDevOps.png", // <-- put your actual image
//   },
...
// // =====================================================================================
// // MINI UI (MiniSection + CourseCardMini)
// // =====================================================================================

// // ✅ GLOBAL icon->image fallback:
// // - If Icon is a real component => render icon
// // - Else if Icon === "none" OR Icon missing => render img (if provided)
// // - Else fallback "?"
// function StackMark({ techKey, size = 18 }) {
//   const t = STACK_TECH[techKey];
//   if (!t) return null;
...
//     return (
//       <I
//         className={t.color || "text-slate-700"}
...
const STACK_TECH = {
  ...
  azuredevops: {
    name: "Azure DevOps",
    Icon: VscAzureDevops,
    img: "/images/courses/azureDevOps.png",
  },
  ...
  // ==================================================
  // ✅ DATA ENGINEERING TECH (Icons + Image fallbacks)
  // ==================================================
...
// AWS services (use Fi icons instead of images)
...
STACK_TECH.partitioning = {
  name: "Partitioning",
  Icon: "none",
  img: "/images/courses/partitioning.png",
};
...
function StackMark({ techKey, size = 18 }) {
  ...
  if ((iconIsNone || !t.Icon) && t.img) {
    return (
      <Image src={t.img} alt={t.name} width={size} height={size} className="object-contain" />
    );
  }
...
// ✅ Data Engineering Card now uses MiniSection (icons)
